...
describe User do
  ...
  describe "micropost associations" do
    ...
    it "should destroy associated microposts on user delete" do
  ...
  describe "accessible attributes" do
    it "should not allow access to :admin" do
      expect do
        @admin_user = User.create(name: "Admin", email: "admin@example.com", admin: true)
  ...
  describe "should be invalid when email is not present" do
    before { @user.email = " " }
    it { should_not be_valid }
  end
  describe "should be invalid when password is not present" do
